...
export async function analyzeRepository(repoData: RepoData): Promise<RepoAnalysis> {
  const prompt = `
...
export async function generateDesignStrategy(analysis: RepoAnalysis): Promise<DesignStrategy> {
  const prompt = `
